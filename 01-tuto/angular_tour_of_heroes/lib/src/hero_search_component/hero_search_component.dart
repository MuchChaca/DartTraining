...
import '../hero_search_service/hero_search_service.dart';
import '../hero.dart';
...
class HeroSearchComponent implements OnInit {
  ...
  Future<Null> ngOnInit() async {
    heroes = _searchTerms.stream
      ...
      .distinct()
      // i hate this one... srsly wtf is wrong with you
      .transform(switchMap((term) => term.isEmpty ? new Stream<List<Hero>>.fromIterable([<Hero>[]]) : _heroSearchService.search(term).asStream()))
      // STOP IT
      .handleError((e) {
